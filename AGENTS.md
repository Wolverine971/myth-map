...
Note: `src/schema.ts` is gitignored / generated; do not hand-edit. The previous AGENTS.md referenced `src/DatabaseDefinitions.ts` — that file does not exist; use `src/schema.ts`.
