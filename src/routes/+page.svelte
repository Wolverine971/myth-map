	...
	<div class="location-grid">
		{#each data.locationTags as locationTags}
			<LocationCard
				...
				address={`${locationTags.locations.address_line_1} ${locationTags.locations.address_line_2}, ${locationTags.locations.city}, ${locationTags.locations.state} ${locationTags.locations.zip_code}`}
